    ...
    <div class="flex">
        <div class="bg-gray-200 w-48 h-screen border-r-2 border-gray-400 pl-6">
            <nav class="pt-4">
                ...
                <router-link to="/contacts/create" class="flex items-center pt-3 hover:text-blue-600 border-r-2 hover:border-blue-600">
                    ...
                    <div class="text-xs pl-3 font-bold">Add New</div>
                </router-link>
                <p class="pt-12 text-gray-500 uppercase font-bold text-xs">General</p>
                
                <router-link to="/contacts" class="flex items-center pt-3 hover:text-blue-600 border-r-2 hover:border-blue-600">
                    ...
                    <div class="text-xs pl-3 font-bold">Contacts</div>
                </router-link>
                <router-link to="/birthdays" class="flex items-center pt-3 hover:text-blue-600 border-r-2 hover:border-blue-600">
                    ...
                    <div class="text-xs pl-3 font-bold">Birthday</div>
                </router-link>
                <p class="pt-12 text-gray-500 uppercase font-bold text-xs">Settings</p>
                <router-link to="/" class="flex items-center pt-3 hover:text-blue-600 border-r-2 hover:border-blue-600">
                    ...
                    <div class="text-xs pl-3 font-bold">Logout</div>
                </router-link>
            </nav>
        </div>
        <div class="flex-1 flex flex-col h-screen overflow-y-hidden">
            <div class="flex px-6 h-16 border-b border-gray-400 flex justify-between items-center">
                <h1 class="font-bold text-sm">Latest Contacts</h1>
                <div class="flex">
                    <div class="relative flex items-center pr-6">
                        <label for="search" class="absolute pl-2">
                        ...
                        <input type="text" id="search" name="search" placeholder="Search" class="pl-7 text-sm focus:outline-none bg-gray-200 py-1 rounded-3xl">
                    </div>
