    ...
    <div class="flex">
        <div class="bg-gray-200 w-48 h-screen border-r-2 border-gray-400 pl-6">
            <nav class="pt-4">
                ...
                <router-link to="/contacts/create" class="flex items-center pt-3 focus:text-blue-600 border-r-2 focus:border-blue-600">
                ...
                <router-link to="/" class="flex items-center pt-3 focus:text-blue-600 border-r-2 focus:border-blue-600">
                    ...
                    <div class="text-xs pl-3 font-bold">Latest</div>
                </router-link>
                <router-link to="/" class="flex items-center pt-3 focus:text-blue-600 border-r-2 focus:border-blue-600">
        ...
        <div class="flex-1 flex flex-col h-screen overflow-y-hidden">
            <div class="flex px-6 h-16 border-b border-gray-400 flex justify-between items-center">
                ...
                <div class="flex">
                    ...
                    <div class="bg-blue-400 rounded-full w-10 h-10 flex justify-center items-center text-white border border-gray-400">VG</div>
                </div>
            </div>
